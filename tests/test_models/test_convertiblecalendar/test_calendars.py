...
from src.models.convertiblecalendar.calendars import (
    ConvertibleCalendar,
    CalendarConversion,
    default_eras,
    default_era_ranges,
...
class ConvertibleCalendarTest(CalendarTestCase, FactoriesMixin):
    ...
    # Weeks
    #
    @patch("src.models.convertiblecalendar.calendars.string_sanitization")
    ...
    @patch("src.models.convertiblecalendar.calendars.integer_sanitization")
